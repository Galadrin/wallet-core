...
using namespace TW;
using namespace TW::Crypto_org;

TEST(Crypto_orgAddress, Valid) {
    ASSERT_TRUE(Address::isValid("__ADD_VALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(Crypto_orgAddress, Invalid) {
    ASSERT_FALSE(Address::isValid("__ADD_INVALID_ADDRESS_HERE__"));

    // TODO: Add more tests
}

TEST(Crypto_orgAddress, FromPrivateKey) {
...
TEST(Crypto_orgAddress, FromPublicKey) {
    // TODO: Check public key type, finalize implementation
...
TEST(Crypto_orgAddress, FromString) {
